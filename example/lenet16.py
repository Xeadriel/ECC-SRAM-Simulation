...
def main_work_flow():
   ...
   bet_data=(1,0.01, 0.007943282347242814, 0.00630957344480193, 0.005011872336272719, 0.003981071705534969, 0.003162277660168376,
   ...
   for i in range(len(bt1)):
       table_str += str(bt1[i]) + "\t" + "\t".join(map(str, accor_data[i])) + "\n"

   # 将表格数据写入txt文件
   # with open("16bit11.txt", "w") as txt_file:
